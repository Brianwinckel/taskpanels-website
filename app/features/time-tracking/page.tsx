...
const faqs = [
  ...
  },
  {
    ...
    a: "No — and intentionally. Auto-tracking based on browser activity or app focus is on the roadmap as an opt-in via Chrome extension, but the default will always be manual. You control what's tracked and what isn't.",
  },
];
