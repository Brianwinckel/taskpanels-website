...
def build():
    ...
    progress = [
        ...
        ["OG image at /og/taskpanels-og.png", "5", "Missing — referenced but file does not exist (C-1)"],
        ["Per-page OG metadata (titles, descriptions, OG images)", "5", "Partial — only sitewide defaults"],
        ["About page with founder bio", "1 / 4", "Not started"],
